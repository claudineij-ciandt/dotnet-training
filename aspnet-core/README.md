...
5. [Injeção de dependência](https://github.com/claudineij-ciandt/dotnet-training/blob/master/aspnet-core/conceitos/dependency-injection/README.md)
6. [(HANDS-ON) Lab 2: dependency injection](https://github.com/claudineij-ciandt/dotnet-training/blob/master/aspnet-core/labs/lab2-di/README.md)
