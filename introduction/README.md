...
4. (DEMO) CLI, solutions and projects
5. [(HANDS-ON) Lab 2: dotnet CLI](https://github.com/claudineij-ciandt/dotnet-training/blob/master/introduction/content/introduction-lab-2.md)
6. [(HANDS-ON) Lab 3: outros recursos do VS Code](https://github.com/claudineij-ciandt/dotnet-training/blob/master/introduction/content/introduction-lab-3.md)